...
def checkout():
    ...
    return render_template("checkout.html", fname_template=first_name, lname_template=last_name, student_id=student_id, straw_amt=strawberry_amt, raspb_amt=raspberry_amt, apple_amt=apple_amt)
